...
import { BillItemDisplayRow, DisplayField, DisplayTable, InfoCard, PreHospDisplayRow, SectionHeader, StatusBadge} from
    '@/components/hr/reviewclaim/ReviewComponents';
       ...
       <div className="mb-6">
         <div className="bg-white p-4 rounded-lg border border-gray-200">
           <div className="flex items-center gap-4">
             ...
             <RadioGroup
               value={postHospitalizationApplicable}
               onValueChange={setPostHospitalizationApplicable}
           ...
           <div className="space-y-3">
             ...
             <div className="flex justify-end">
               <Button
                 ...
                 className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-md font-medium h-9"
               >
                 Confirm
               </Button>
             </div>
