...
export default function AdvanceApprovalForm({ estimatedAmount, onSubmit, approvalLoading }: AdvanceApprovalFormProps) {
  ...
  return (
    <Card className="border border-blue-200 shadow-lg rounded-xl p-4">
      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Estimated Amount */}
                  ...
                  <FormItem className="md:col-span-2">
                    <div className="flex items-center gap-2">
                      ...
                      <FormLabel htmlFor="agree" className="text-sm text-gray-700 font-normal">
                        I, the undersigned, hereby declare that the information given in this form is correct and complete to the best of my knowledge and
                        belief.
                      </FormLabel>
                    </div>
            ...
            <div className="md:col-span-2 text-right">
              <Button type="submit">{approvalLoading ? 'Submitting...' : 'Submit Approval'}</Button>
            </div>
          </form>
        </Form>
      </CardContent>
